...
public class AnimatorScriptS : MonoBehaviour
{
    ...
    public void AnimatorManager(bool grounded, float currentSpeed, bool boostingCurrently, float moveX, float moveY, bool accell)
    {
    ...
    public void FootstepAnimSoundPlayer()
    {
        ...
        string stepSound = soundStartName + random;
        footStepManagerAudio.Play(stepSound);
    }
