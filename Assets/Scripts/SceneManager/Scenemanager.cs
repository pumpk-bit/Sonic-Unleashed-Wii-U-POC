...
public class Scenemanager : MonoBehaviour {
    ...
    [SerializeField] bool AgingTest = false;
    ...
    [SerializeField] private string StartingSong;

    //Delete tem later, just for testing
    [SerializeField] private string StartingSong1;
    [SerializeField] private string StartingSong2;
    [SerializeField] private string StartingSong3;
    [SerializeField] private string StartingSong4;
    [SerializeField] private string StartingSong5;
    ...
    void Start()
    {
        ...
        if (AgingTest == true)
        {
            StartCoroutine(LoadSceneSR());
        }
    }

    private void PlayStartingSong()
    {
        MusicManager.Play(StartingSong);
        MusicManager.Play(StartingSong1);
        MusicManager.Play(StartingSong2);
        MusicManager.Play(StartingSong3);
        MusicManager.Play(StartingSong4);
        MusicManager.Play(StartingSong5);
    }
    ...
    {
        MusicManager.StopPlaying(StartingSong);
