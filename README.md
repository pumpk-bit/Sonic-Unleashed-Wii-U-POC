...
textures.spriters-resource.com
...
Special thanks to Retro&Dev for the Wii U Cafe SDK Deluxe.


Note:

Sonic the Hedgehog and Sonic Unleashed are properties of SEGA.
This project will be removed if requested by the rights holder.
